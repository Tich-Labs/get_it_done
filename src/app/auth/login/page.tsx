        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-zinc-200 p-8">
            ...
            <div className="mt-6">
              ...
              <button
                type="button"
                className="mt-4 w-full bg-white border border-zinc-300 text-zinc-700 py-3 rounded-xl font-semibold hover:bg-zinc-50 transition-colors flex items-center justify-center gap-3"
              >
